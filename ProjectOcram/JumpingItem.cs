//-----------------------------------------------------------------------
// <copyright file="JumpingItem.cs" company="Tristan Araujo & Dominik Desjardins">
...
namespace ProjectOcram
{
    ...
    /// Pour sa collision
    /// </summary>
    public class JumpingItem : Sprite
    {
        /// <summary>
        ...
        public JumpingItem(Vector2 position)
        ...
        public JumpingItem(float x, float y) : base(x, y)
        {
        }
        ...
        /// </summary>
        public Rectangle JumpingItemCollision { get; set; }
        ...
        public static void LoadContent(ContentManager content, GraphicsDeviceManager graphics)
        {
            ...
            texture = content.Load<Texture2D>(@"Extra\JumpJump");
        }
