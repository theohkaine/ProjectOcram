//-----------------------------------------------------------------------
// <copyright file="Boss.cs" company="Tristan Araujo & Dominik Desjardins">
...
namespace ProjectOcram
{
    ...
    /// <summary>
    /// Classe implantant une affichage du boss avec un Rectangle
    /// Pour sa collision
    /// </summary>
    public class Boss : Sprite
    {
        ...
        /// <summary>
        /// Rectangle pour l'implémentassion de la collision sur la texture du boss.
        /// </summary>
