...
namespace ProjectOcram
{
    ...
    {      
        ...
        public Miroyr(Vector2 position)
        ...
        protected override Palette PaletteAnimation
        {
            ...
            get { return this.Palettes[((int)this.Etat * 9) + (int)this.DirectionDeplacement]; }
        }
