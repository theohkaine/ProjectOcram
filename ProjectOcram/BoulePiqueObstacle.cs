//-----------------------------------------------------------------------
// <copyright file="BoulePiqueObstacle.cs" company="Tristan Araujo & Dominik Desjardins">
...
namespace ProjectOcram
{
    ...
    /// <summary>
    /// Classe implantant une affichage d'une boule de pique avec un Rectangle
    /// Pour sa collision
    /// </summary>
    public class BoulePiqueObstacle : Sprite
    {
        ...
        /// <summary>
        /// Rectangle pour l'implémentassion de la collision sur la texture de la boule.
        /// </summary>
