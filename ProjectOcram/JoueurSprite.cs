...
namespace ProjectOcram
{
    ...
    /// animé peut être stationnaire, marcher et courir dans deux directions.
    /// </summary>
    public class JoueurSprite : SpriteAnimation
    {
        /// <summary>
        /// Affichage de la texture rectangle qui va contenir le rectangle de la barre de vie.
        /// </summary>
        private static Texture2D rectTexture;

        /// <summary>
        /// Affichage d'un rectangle d'une couleur pour représenter la vie du personnage.
        /// </summary>
        ...
        /// <summary>
        /// Effet sonore joué lors du dashing.
        /// </summary>
        ...
        /// <summary>
        ///  Savoir si le personnage a Dash.
        /// </summary>
        private bool hasDashedGauche = false;
        ...
        /// Le temps d'un Dash.
        /// </summary>
        private int dashTime = 300;

        /// <summary>
        /// Le temps que le personnage doit attendre pour faire un autre Dash.
        /// </summary>
        private int dashCooldown = 500;

        /// <summary>
        /// Savoir si le personnage est dans l'etat Dash.
        /// </summary>
        private int currentDashDroite = 0;

        /// <summary>
        ///  Savoir si le personnage a Dash.
        /// </summary>
        private bool hasDashedDroite = false;

        /// <summary>
        ///  Savoir si le personnage est dans l'etat Dash.
        /// </summary>
        private int currentDashGauche = 0;
        ...
        public enum Direction
        {
            ...
            /// <summary>
            /// Déplacement vers la gauche de l'écran lors d'un Dashing.
            /// </summary>
            DashingGauche,

            /// <summary>
            /// Déplacement vers la droite de l'écran lors d'un Dashing.
            /// </summary>
            DashingDroite
        }
        ...
        public enum Etats
        {
            ...
            /// <summary>
            /// Le personnage ne se déplace pas et tire un obus.
            /// </summary>
            ShootingIdle,

            /// <summary>
            /// Le personnage se déplace et tire un obus.
            /// </summary>
            ShootingRunning,

            /// <summary>
            /// Le personnage saute et tire un obus.
            /// </summary>
            ShootingJumping
        }

        /// <summary>
        /// Rectangle pour l'implémentassion de la collision sur la texture du personnage.
        /// </summary>
        ...
        public override void Update(GameTime gameTime, GraphicsDeviceManager graphics)
        {
            ...
            float vitesseDashingG = ServiceHelper.Get<IInputService>().DashingDroite(this.indexPeripherique);
            float vitesseDashingD = ServiceHelper.Get<IInputService>().DashingGauche(this.indexPeripherique);
            ...
            if (vitesseDashingD == 1 && this.hasDashedDroite == false)
            {
                dashingFX.Play(this.volume, this.pan, this.pitch);
                this.currentDashDroite = this.dashTime + this.dashCooldown;
                this.hasDashedDroite = true;
            }
            else
            {
                if (this.currentDashDroite > this.dashCooldown)
                {
                    //// Movement code
                    this.directionDeplacement = Direction.DashingDroite;
                    deltaX = (int)(-8);
                }
                else if (vitesseDashingD == 0 && this.currentDashDroite <= 0)
                {
                    this.hasDashedDroite = false;
                }

                this.currentDashDroite -= gameTime.ElapsedGameTime.Milliseconds;
            }

            if (vitesseDashingG == 1 && this.hasDashedGauche == false)
            {
                dashingFX.Play(this.volume, this.pan, this.pitch);
                this.currentDashGauche = this.dashTime + this.dashCooldown;
                this.hasDashedGauche = true;
            }
            else
            {
                if (this.currentDashGauche > this.dashCooldown)
                {
                    //// Movement code
                    this.directionDeplacement = Direction.DashingGauche;
                    deltaX = (int)8;
                }
                else if (vitesseDashingG == 0 && this.currentDashGauche <= 0)
                {
                    this.hasDashedGauche = false;
                }

                this.currentDashGauche -= gameTime.ElapsedGameTime.Milliseconds;
            }
            ...
            {             
                attackFX.Play(this.volume, this.pan, this.pitch);
        ...
        /// <summary>
        /// Affichage de la barre de vie au desus du personnage
        /// </summary>
        /// <param name="camera">Fait en sorte que le rectangle soit toujours au desus du personnage.</param>
        /// <param name="spriteBatch">Affichage du rectangle.</param>
        ...
        /// <summary>
        /// Ajuster et afficher la position de la barre de vie au desus du personnage
        /// </summary>
        /// <param name="camera">Fait en sorte que le rectangle soit toujours au desus du personnage.</param>
        /// <param name="spriteBatch">Affichage du rectangle.</param>
        private void DrawVitalite(Camera camera, SpriteBatch spriteBatch)
        {
            ...
            Rectangle rect = new Rectangle((int)(this.Position.X - 45), (int)(this.Position.Y - (this.Height / 2) - 23), this.Width + 55, 35);

            // Créer le rectangle à dessiner.
            Rectangle rectOnTop = new Rectangle((int)(this.Position.X - 27), (int)(this.Position.Y - (this.Height / 2) - 8), (this.Width / 2) + 40, 4);
            ...
            if (this.playerHP == 2)
            {
                ...
                //// Créer le rectangle à dessiner.
                Rectangle rectOnTop2 = new Rectangle((int)(this.Position.X - 27), (int)(this.Position.Y - (this.Height / 2) - 8), (this.Width / 2) + 20, 4);
            ...
            if (this.playerHP == 1)
            {
                ...
                //// Créer le rectangle à dessiner.
                Rectangle rectOnTop3 = new Rectangle((int)this.Position.X - 27, (int)(this.Position.Y - (this.Height / 2) - 8), this.Width / 2, 4);
